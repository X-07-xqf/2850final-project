...
The assignment is rated amber for use of generative AI, meaning AI tools may be used in a supportive role and must be acknowledged. This document serves as a canonical record of where and how generative AI was used in this codebase.
...
| File | Drafted by AI | Human verification |
|---|---|---|
...
- The committer / author of every commit is the human team member running the tool, and never the AI service account. We do not use `Co-Authored-By: <AI>` git trailers because the assignment expects human authorship with AI in a supportive role, and the trailer would misrepresent contribution attribution.
